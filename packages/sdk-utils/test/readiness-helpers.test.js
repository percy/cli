...
describe('readiness helpers', () => {
  ...
  describe('normalizeOptions', () => {
    ...
    it('normalizes domStability to dom_stability', () => {
      let n = normalizeOptions({ domStability: false });
      expect(n.dom_stability).toBe(false);
    });

    it('accepts dom_stability in snake_case', () => {
      let n = normalizeOptions({ dom_stability: false });
      expect(n.dom_stability).toBe(false);
    });

    it('prefers camelCase domStability when both are provided', () => {
      let n = normalizeOptions({ domStability: false, dom_stability: true });
      expect(n.dom_stability).toBe(false);
    });
