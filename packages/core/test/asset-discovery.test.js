...
describe('Asset Discovery', () => {
  ...
  it('logs detailed debug logs', async () => {
    ...
    expect(stdio[1]).toEqual(expect.arrayContaining([
      ...
      '[percy] Discovering resources @ 400px: http://localhost:8000/\n',
      '[percy] Handling request: http://localhost:8000/\n',
      '[percy] Serving root resource: http://localhost:8000/\n',
      '[percy] Handling request: http://localhost:8000/style.css\n',
      '[percy] Handling request: http://localhost:8000/img.gif\n',
      ...
      '[percy] Discovering resources @ 1200px: http://localhost:8000/\n',
      '[percy] Handling request: http://localhost:8000/\n',
      '[percy] Serving root resource: http://localhost:8000/\n',
      '[percy] Handling request: http://localhost:8000/style.css\n',
      '[percy] Response cache hit: http://localhost:8000/style.css\n',
      '[percy] Handling request: http://localhost:8000/img.gif\n',
      '[percy] Response cache hit: http://localhost:8000/img.gif\n',
